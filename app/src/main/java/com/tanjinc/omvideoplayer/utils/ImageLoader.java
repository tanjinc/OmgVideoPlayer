package com.tanjinc.omvideoplayer.utils;
...
//        new ImageAsyncLoader(url, imageView, width, height).execute();
        Glide.with(context)
                .load(url)
                .centerCrop()
                .into(imageView);
    ...
    private class ImageAsyncLoader extends AsyncTask<String, Void, Bitmap> {
        ...
        public ImageAsyncLoader(String url, ImageView imageView, int width, int height) {
            mUrl = url;
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap.getWidth() > mImageViewWidth || bitmap.getHeight() > mImageViewWidth) {
